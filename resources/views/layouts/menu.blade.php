...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item mr-auto"><a class="navbar-brand" href="#">
                    ...
                    <img src="{{asset('logo.png')}}" style="width:35px;height:25px;">
                    <h2 class="brand-text mb-0">Weather</h2>
                </a></li>
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item {{ request()->is('perangkat') ? 'active' : '' }}"><a href="{{route('perangkat.index')}}"><i class="feather icon-cpu"></i><span class="menu-title" data-i18n="Email">Perangkat</span></a>
            </li>
